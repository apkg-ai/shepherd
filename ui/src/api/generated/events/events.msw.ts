...
export const getGetEventsResponseMock = (): string => (faker.word.sample())


export const getGetEventsMockHandler = (overrideResponse?: string | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<string> | string), options?: RequestHandlerOptions) => {
  return http.get('/api/v1/events', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {
