 ...
 */
export const getEvents = async (params?: GetEventsParams, options?: Parameters<typeof shepherdFetch>[1]): Promise<string> => {
...
export const getGetEventsQueryOptions = <TData = Awaited<ReturnType<typeof getEvents>>, TError = UnauthorizedResponse | ValidationErrorResponse | TooManyRequestsResponse | InternalErrorResponse>(params?: GetEventsParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEvents>>, TError, TData>>, request?: SecondParameter<typeof shepherdFetch>}
) => {
...
export type GetEventsQueryError = UnauthorizedResponse | ValidationErrorResponse | TooManyRequestsResponse | InternalErrorResponse


export function useGetEvents<TData = Awaited<ReturnType<typeof getEvents>>, TError = UnauthorizedResponse | ValidationErrorResponse | TooManyRequestsResponse | InternalErrorResponse>(
...
export function useGetEvents<TData = Awaited<ReturnType<typeof getEvents>>, TError = UnauthorizedResponse | ValidationErrorResponse | TooManyRequestsResponse | InternalErrorResponse>(
 params?: GetEventsParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getEvents>>, TError, TData>>, request?: SecondParameter<typeof shepherdFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Subscribe to domain events via SSE
