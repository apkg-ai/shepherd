# 009 — Planning and execution leases

Status: not started. Requirements: CLAIM-01 FLOW-02.

## Objective and prerequisites

Deliver planning and execution leases. Required completed steps: [008](008-proposals-and-policy.md)
...
2. Implement claimTask for plan/execute, random lease, phase context pins, renew/release and expiry sweep. Re-read dependencies and selected plan under write lock. Update epic active only on execution start. Persist idempotent claim grant encrypted; require If-Match at claim acquisition, not renewal.
...
Ten simultaneous claims yield one active winner. Planning claim while upstream epic waits succeeds; execute fails. Renew at exact expiry fails. Block epic revokes planning/execution claims. Lost claim response replay returns same lease; release does not erase saved output.
