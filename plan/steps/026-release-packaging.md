# 026 — macOS and Linux packaging

Status: not started. Requirements: OPS-01.

## Objective and prerequisites

Deliver macos and linux packaging. Required completed steps: [020](020-ui-live-settings.md), [022](022-cli.md), [023](023-mcp.md), [025](025-diagnostics.md)

Read [execution rules](README.md) first, then:

- [13-storage-backup-and-release.md](../13-storage-backup-and-release.md)
...
2. Add release workflow for three target triples, matching UI/static assets and client binaries, version manifest, checksums and local installation guide. Resolve assets relative to executable. Pin artifact-building actions/tools following existing CI practice.
...
Extract in clean temp directory and launch from unrelated cwd. UI/login/API/CLI/MCP health scenario passes per platform. Checksums verify. Missing UI assets fail with actionable error. No signing/notarization claim is made.
